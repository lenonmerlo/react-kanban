    ...
    return (
        <Dialog.Root>
            ...
            <Dialog.Content maxWidth="32rem">
                ...
                <Dialog.Description size="2" mb="4">Adicionar novas tarefas ao quadro</Dialog.Description>
                        ...
                        <Flex gap="8">
                            <Box>
                                ...
                                <RadioGroup.Root name="status" defaultValue="todo">
                                    ...
                                    <RadioGroup.Item value="done"><Badge color="green">Concluído</Badge></RadioGroup.Item>
                                </RadioGroup.Root>
                            </Box>
                            <Box>
